...
function Socials() {
  ...
  return (
    <div
      id="contact"
      className="flex flex-col space-y-10 justify-center items-center mb-28"
    >
      ...
      <div className="flex scale-50 md:scale-100 space-x-2 md:space-x-10 md:justify-center items-center">
        <Link
          ...
          target="_blank"
          className="text-black font-bold bg-white flex justify-center items-center space-x-2 rounded-full border-transparent border-2 px-2 py-1"
        >
          <svg
